...
export const createOrUpdateTransaction = async (
  ...
  try {
    ...
    const dataToSave: Partial<TransactionType> = { ...transactionData };
    ...
    if (image) {
      ...
      dataToSave.image = imageUploadRes.data;
    } else {
    ...
    return {
      success: true,
      data: { ...dataToSave, id: transactionRef.id },
    };
  } catch (err: any) {
...
export const fetchWeelyStats = async (uid: string): Promise<ResponseType> => {
  try {
    const db = firestore;
